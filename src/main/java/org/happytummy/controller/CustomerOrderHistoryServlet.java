...
@WebServlet(name = "CustomerOrderHistoryServlet", value = "/CustomerOrderHistoryServlet")
public class CustomerOrderHistoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try{
            List<OrderPojo> orderList = OrderModel.getAllDeliveredOrders(UserProfile.getCustomerId());
