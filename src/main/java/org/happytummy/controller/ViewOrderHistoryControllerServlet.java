...
@WebServlet(name = "ViewOrderHistoryControllerServlet", value = "/ViewOrderHistoryControllerServlet")
public class ViewOrderHistoryControllerServlet extends HttpServlet {
    @Override
    ...
    protected void processRequest(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try{
            List<OrderPojo> orderList = OrderModel.getAllDeliveredOrders();
