    ...
    <div class="row justify-content-center">
        <div class="col-md-6 content-container">
            <div class="image-container">
                <img src="<%=p.getpURL()%>" class="img-fluid" alt="Placeholder Image">
            </div>
            <div class="form-container">
                <form action="UpdateFoodControllerServlet">
                    <div class="form-group">
                        <label for="name">Name:</label>
                        <input type="text" class="form-control"  id="name" name="name" value="<%=p.getpName()%>">
                    </div>
                    <div class="form-group">
                        <label for="price">Price:</label>
                        <input type="text" class="form-control" id="price" name="price" value="<%=p.getpPrice()%>">
                    </div>
                    <button type="submit" name="id" value="<%=p.getpID()%>" class="btn btn-primary">Submit</button>
                </form>
            </div>
        </div>
    </div>
